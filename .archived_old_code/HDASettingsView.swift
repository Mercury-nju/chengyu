        ...
        NavigationView {
            ...
            .onAppear {
                Task {
                    ...
                    // Auto-request if not determined
                    if screenTimeMonitor.authorizationStatus == .notDetermined {
                        print("🔐 [HDASettings] Status not determined, requesting authorization...")
        ...
        VStack(spacing: 12) {
            ...
            HStack(spacing: 16) {
                HStack(alignment: .firstTextBaseline, spacing: 4) {
                    ...
                    Button(action: {
                        print("🔄 [HDASettings] Manual sync triggered")
                        Task {
                            await screenTimeMonitor.syncAndApplyImpact()
                        }
                    }) {
